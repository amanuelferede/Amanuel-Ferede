export default function ServiceTypes() {
    return (
      ...
      <div className="grid md:grid-cols-3 gap-5 md:py-15 py-5 md:px-0 px-3 lg:max-w-6xl xl:max-w-350 mx-auto">
        <div className="h-75 bg-red-400 md:rounded-xl shadow-xl text-center flex items-center justify-center">
         ...
         <div className="h-75 bg-green-400 md:rounded-xl shadow-xl text-center flex items-center justify-center">
          <div className="flex flex-col space-y-2">
        ...
        <div className="h-75 bg-blue-400 md:rounded-xl shadow-xl text-center flex items-center justify-center">
          <div className="flex flex-col space-y-2">
