...
export default function ServiceTypes() {
  return (
    ...
    <div className="grid md:grid-cols-3 gap-5  py-5 md:px-0 px-3 lg:max-w-6xl xl:max-w-350 mx-auto">
      ...
      <div className="  md:rounded-xl shadow-xl text-center flex items-center justify-center">

        <div className="flex flex-col space-y-2">
          <Image src={`/services/web dev.jpg`} width={0} height={0} className="w-full h-65" sizes="100vh" alt="web desgin" />
      ...
      <div className="  md:rounded-xl shadow-xl text-center flex items-center justify-center">
        ...
        <div className="flex flex-col space-y-2">
          <Image src={`/services/software dev.jpg`} width={0} height={0} className="w-full h-65" sizes="100vh" alt="web desgin" />
      ...
      <div className="  md:rounded-xl shadow-xl text-center flex items-center justify-center">
        ...
        <div className="flex flex-col space-y-2">
          <Image src={`/services/graphics design.jpg`} width={0} height={0} className="w-full h-65" sizes="100vh" alt="web desgin" />
