                ...
                <div className="text-center md:max-w-5xl py-10 md:mx-auto w-full md:px-0 px-3">
                    <div className="text-center md:w-3/4 w-full">
                        <div className="md:border-l-8 md:my-7 md:border-blue-700 md:pl-5 text-center">
                            <p className="font-semibold md:text-justify text-3xl mb-2">What makes our web solutions stand out.
                            </p>
                            <p className=" md:text-justify text-xl">We belive in innovation, transparancy and long-term partnerships. Every project is treated as an opportunity to make an impact. - not just deliver a webiste.</p>
                ...
                <div className="grid md:grid-cols-3 gap-5 md:px-0 px-3">
                    <div className="h-75 bg-white md:rounded-lg p-5 md:shadow-lg shadow-md text-center flex items-center justify-center">
                        <div className="flex flex-col space-y-2">
                            ...
                            <p>We begin by undrestainding your business goals, trget audineces and competition.</p>
                        </div>
                    </div>
                    <div className="h-75 bg-white md:rounded-lg p-5 md:shadow-lg shadow-md text-center flex items-center justify-center">
                        <div className="flex flex-col space-y-2">
                            <p className="font-semibold text-2xl">Design excellence.</p>
                            <p>Every layout, image and color scheme is chosen to resonate with your audinece.</p>
                        </div>
                    </div>
                    <div className="h-75 bg-white md:rounded-lg p-5 md:shadow-lg shadow-md text-center flex items-center justify-center">
                        <div className="flex flex-col space-y-2">
                            <p className="font-semibold text-2xl">Seamless functionality</p>
                            <p>We focus on performance, security and scaliablity to ensure your webiste runs smoothly.</p>
                        </div>
                    </div>
                    <div className="h-75 bg-white md:rounded-lg p-5 md:shadow-lg shadow-md text-center flex items-center justify-center">
                        <div className="flex flex-col space-y-2">
                            <p className="font-semibold text-2xl">Continous suppoprt.</p>
                            <p>From maintencance to updates, we stand by you even after project delivery. Our motto is simple Your success is our success.</p>
                        </div>
                    </div>
