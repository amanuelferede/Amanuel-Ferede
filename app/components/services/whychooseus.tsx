     ...
     <div className="py-15 lg:max-w-6xl xl:max-w-350 mx-auto">
        ...
        <div className="text-center">
          <div className="border-l-8 my-7 border-l-blue-600 pl-5 text-2xl  text-center my-1 inline-block">
            <p className=" p-3 font-semibold text-justify text-xl">Why choose us.
            </p>
            <p className=" p-3 text-justify text-xl">We understand that every business is unique, and so should be its website. Our mission is to create digital expereinces that not only look great but aslo perform flawlessly.</p>
